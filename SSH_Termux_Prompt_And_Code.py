...
class EnhancedSSHConnector:
    def __init__(self):
        ...
        self.cred_manager = CredentialsManager()  # Renamed to avoid conflict
    ...
    def display_menu(self):
        ...
        # Display suggestions based on selection
    ...
    def credentials_manager_menu(self):  # Renamed from credentials_manager
    ...
    def change_master_password(self):
        ...
        try:
            ...
            if connections:
                # Try to decrypt first connection's password if exists
        ...
        while True:
            ...
            try:
                if self.input_mode:
                    ...
                    elif key in ['A', 'w']:  # Up arrow or w
                        self.selected_option = max(0, self.selected_option - 1)
                    elif key in ['B', 's']:  # Down arrow or s
    ...
    def execute_selected_option(self):
        ...
        options = {
            ...
            4: self.port_scan,
            5: self.network_info,
            6: self.credentials_manager_menu,  # Fixed: using renamed method
            7: self.install_ssh,
